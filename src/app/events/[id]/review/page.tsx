...
import { ArrowLeft, Clock3, Sparkles, ArrowRight } from "lucide-react";
  ...
  return (
    <main className="min-h-screen pb-24">
      ...
      <div className="mx-auto max-w-4xl px-6 pt-8">
        ...
        <p className="mt-1 text-ink-soft">Double-check everyone&apos;s order before you place it as one.</p>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    {p.eta && <p className="flex items-center justify-end gap-1 text-xs text-ink-soft"><Clock3 className="h-3 w-3" /> {p.eta}</p>}
                  </div>
                </div>
